...
L["Preydator Updates: New in 1.7.0"] = "Preydator更新: 1.7.0新内容"
L["WHATS_NEW_BODY"] = "追踪更新已到来。\n\n- 狩猎面板追踪已更新，提高了可靠性和奖励可见性\n- 战团追踪已更新，改进了猎物进度和布局处理\n- 货币追踪继续提供追踪货币筛选和布局/主题控制\n\n狩猎追踪器对新安装默认开启。货币和战团窗口仍默认关闭，可随时从货币选项页面或小地图图标启用。"
L["Got It"] = "知道了"
